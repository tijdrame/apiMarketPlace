...
public class NotifyPickupRequest {
    ...
    public NotifyPickupRequest(String docRef, String receiptNum, LocalDate deliveryDate, String deliveryAddress, String deliveryUser, String status, String motif, String langue, String country) {
        this.docRef = docRef;
